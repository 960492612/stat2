...
<script>
import { addSalesByOrder, getCountOrderByDate } from "api/logistics";
import { formatTime } from "common/js/util";
import { LogisticsByOrderKey } from "common/js/config";
...
export default {
  ...
  computed: {
    ...
    keys() {
      return Object.values(LogisticsByOrderKey);
    }
  },
  methods: {
    generateDate({ header, results }) {
      ...
      // 保证表格字段的准确性
      let keys = Object.values(LogisticsByOrderKey);
