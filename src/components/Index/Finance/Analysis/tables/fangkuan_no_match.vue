  ...
  <div class="FangkuanResult">
    ...
    <div class="content">
      <el-table :data="part" v-loading="loading" max-height="650" element-loading-text="拼命加载中">
        ...
        <el-table-column label="放款表时间" prop="放款表时间" header-align="center" align="center"></el-table-column>
...
<script>
import { getFangkuanHuiZong_no_matched } from "api/finance";
