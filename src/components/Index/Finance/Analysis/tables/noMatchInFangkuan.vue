  ...
  <div class="FangkuanResult">
    ...
    <div class="content">
      <el-table :data="part" v-loading="loading" max-height="650" element-loading-text="拼命加载中">
        ...
        <el-table-column label="放款总额" prop="放款总额" header-align="center" align="center"></el-table-column>
      </el-table>
    </div>
...
<script>
import { getNoMatchInFangkuan } from "api/finance";
...
export default {
  ...
  computed: {
    xlsName() {
      ...
      return `${formatTime(this.time.getTime(), "yyyy年MM月")}放款无资金有.xls`;
    },
    json_fields() {
